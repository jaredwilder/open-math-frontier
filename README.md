...
- [Dump discoverability audit](DUMP-DISCOVERABILITY-AUDIT-2026-09-13.md) — five new focused homes, the C3 proof-package connection, and remaining buried programs;
